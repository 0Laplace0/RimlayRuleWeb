      ...
      <div className="flex-1 w-full max-w-5xl mx-auto px-4 py-8 flex flex-col items-center">
        ...
        {!loading && !error && selectedCategory && (
          <div className="w-full space-y-6 animate-fadeIn">
            ...
            {/* =================== 1. ฝั่ง กฎทั่วไป (แสดงเป็นหัวข้อ + รายการ + ภาพ) =================== */}
            {!isFineCategory ? (
                  ...
                  <div className="space-y-4 pt-6 border-t border-gray-100">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {selectedCategory.images.map((img, imgIdx) => (
                        <div key={imgIdx} className="space-y-2 bg-gray-50 p-3 rounded-xl border border-gray-200">
                          <img
                            src={`http://localhost:5000${img.imageUrl}`}
                            alt={img.caption || 'rule-img'}
                            className="w-full h-auto rounded-lg border border-gray-200 shadow-sm object-cover max-h-96"
                          />
                          {img.caption && (
